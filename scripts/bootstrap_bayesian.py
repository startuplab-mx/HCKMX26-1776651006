...
SAFE_PHRASES = [
    ...
    # Greetings + casual chat (heavy-rotation expansion to balance classes)
    "hola",
    "que tal",
    "como estas",
    "como estuvo tu dia",
    ...
    "que tengas suerte",
    # Family / household
    "voy con mis tios el domingo",
    "voy con mis primos al cine",
    "mi abuela me hizo de comer",
    "mi mama me dio mesada",
    "mi papa esta en el trabajo",
    "mi hermano esta jugando",
    "mi hermana esta haciendo tarea",
    "mi familia esta bien gracias",
    "voy a la casa de mi tia",
    # School
    "ya termine la tarea",
    "el maestro me regañó",
    "saque diez en historia",
    "me toca clase de mate",
    "me reprobaron y mis papas no saben",
    "tengo examen mañana",
    "voy al recreo",
    # Casual money / shopping (the expensive FP class)
    "me sacaron 500 pesos del monedero",
    "me robaron la cartera ayer",
    "me cobraron 200 pesos por el envio",
    "compre un cafe de 50 pesos",
    "le pague 100 pesos a mi amigo",
    "tengo que ahorrar para los tenis",
    "cuanto cuesta el helado",
    "me prestaron 200 pesos en la cooperativa",
    "me regalaron mi mesada",
    "me debe dinero mi amigo",
    "compre comida para mi gato",
    "ya pague la luz",
    "voy al super con mi mama",
    "me cobraron de mas en la tienda",
    "el cine cuesta caro ahora",
    # Gaming + streaming (also FP-prone)
    "ya termine el pase de batalla",
    "me dieron item raro en el dungeon",
    "voy a stream en twitch",
    "subi un video a youtube",
    "me gane el rank",
    "estoy en queue de valorant",
    "voy a jugar mortal kombat",
    "me invitaron a un torneo de fifa",
    # Media / movies
    "la película fue buenísima",
    "vi la nueva pelicula de marvel",
    "vi el capitulo de stranger things",
    "vamos al cine este finde",
    "que peli vamos a ver",
    # Daily activities
